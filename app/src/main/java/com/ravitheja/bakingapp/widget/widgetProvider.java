package com.ravitheja.bakingapp.widget;
...
import static com.ravitheja.bakingapp.widget.UpdateBakingService.FROM_ACTIVITY_INGREDIENTS_LIST;
...
public class widgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        Intent appIntent = new Intent(context, ReciepeDetailActivity.class);
